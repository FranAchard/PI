...
let url = await axios({
    method: "get",
    url: `https://api.rawg.io/api/games?key=90c0880a3a3241f5b5034d480b57d898&page=${i}`,
...
get_oneVideogameAp = async (id) => {
    try {
        ...
        method: "get",
        url: `https://api.rawg.io/api/games/${id}?key=90c0880a3a3241f5b5034d480b57d898`,
        headers: { "Accept-Encoding": "null" },
        })
...
const res = await axios({
    method: "get",
    url:`https://api.rawg.io/api/games?key=90c0880a3a3241f5b5034d480b57d898&search=${name}`,
    headers: { "Accept-Encoding": "null" },
})
